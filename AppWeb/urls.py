...
urlpatterns = [
    ...
    path("crear_noticia/", views.NoticiaCreateView.as_view() , name="CrearNoticia"),
    ...
    path('buscador/', busqueda, name="buscador"),
    path("noticia_funcion/", noticia_funcion, name = "funcion_imagen"),
]